package serenityswag.cart.pageObjects;
...
public class CartPageObject extends PageObject {
    ...
    public List<CartItem> items() {
        // map() on findAll() automatically creates a list Collection that is returned
        return findAll(CART_ITEMS).map(item -> new CartItem(
